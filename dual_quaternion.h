...
extern "C" {
  ...
  // Quaternion-dual_quaternion binary dual_quaternion returners
...
//  }
  ...
  // Quaternion-dual_quaternion/dual_quaternion-scalar binary quaternion returners
  ...
  static NPY_INLINE double rotor_intrinsic_distance(dual_quaternion q1, dual_quaternion q2) {
    return 2*dual_quaternion_absolute(dual_quaternion_log(dual_quaternion_divide(q1,q2)));
  }
  static NPY_INLINE double rotor_chordal_distance(dual_quaternion q1, dual_quaternion q2) {
    return dual_quaternion_absolute(dual_quaternion_subtract(q1,q2));
  }
  static NPY_INLINE double rotation_intrinsic_distance(dual_quaternion q1, dual_quaternion q2) {
  ...
  static NPY_INLINE double rotation_chordal_distance(dual_quaternion q1, dual_quaternion q2) {
    if(rotor_chordal_distance(q1,q2)<=1.414213562373096) {
      return dual_quaternion_absolute(dual_quaternion_subtract(q1,q2));
    } else {
